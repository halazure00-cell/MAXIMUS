...
const ALIAS_MAP: Record<string, string> = {
  ...
  "Koridor Caringin (Akses Pasar Induk)": "Jalan Caringin Bandung",
  ...
  "Cisaranten Kulon (Area)": "Cisaranten Kulon",
  ...
  "Sarijadi (Komplek)": "Sarijadi",
  "Jalan Braga": "Jalan Braga",
  "Gedung Merdeka (Asia Afrika)": "Gedung Merdeka",
  "Pasar Kosambi": "Pasar Kosambi",
  "Terminal Ujung Berung": "Terminal Ujung Berung",
  
  // FIX UNTUK YANG MASIH GAGAL (Simplifikasi Nama)
  "Kuliner Terusan Jakarta (Antapani)": "Jalan Terusan Jakarta",
  "Cibadak Culinary Night": "Jalan Cibadak",
  "Babakan Ciparay (Pusat Area)": "Babakan Ciparay",
  "Cicadas (Koridor A. Yani)": "Cicadas",
  "Pasar Cibiru": "Cibiru",
  "Terminal Cibiru": "Bundaran Cibiru",
  "Cisaranten Wetan (Area)": "Cisaranten Wetan",
  "Cinambo (Pusat Area)": "Cinambo",
  "Stadion Gelora Bandung Lautan Api (GBLA)": "Gelora Bandung Lautan Api Stadium",
  "Jatihandap (Area)": "Jatihandap",
  "Pasar Ciwastra": "Jalan Ciwastra",
  "Derwati (Area)": "Derwati",
  "Gerbang Tol Pasteur": "Jalan Dr. Djunjunan",
  "Alun-Alun Ujung Berung": "Alun Alun Ujungberung"
};
